...
// Contexts returns the schema registry contexts available in the schema registry.
//
...
// DeleteContext deletes a schema registry context from the schema registry.
func (cl *Client) DeleteContext(ctx context.Context, srContext string) error {
	// DELETE /contexts/{context}
	return cl.delete(ctx, fmt.Sprintf("/contexts/%s", url.PathEscape(srContext)), nil)
}
