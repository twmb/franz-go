...
func TestClientIntegration(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			act: func(t *testing.T, cl *sr.Client) (any, error) {
				return cl.Subjects(sr.InContext(context.Background(), ".myctx"))
			},
		...
		},
		{
			...
			act: func(t *testing.T, cl *sr.Client) (any, error) {
				return cl.SchemaByID(sr.InContext(context.Background(), ".myctx"), 1)
			},
			wantResult: userSchema,
		},
		{
		...
		},
		{
			...
			act: func(t *testing.T, cl *sr.Client) (any, error) {
				return cl.SubjectsByID(sr.InContext(context.Background(), ".myctx"), 1)
			},
			wantResult: []string{":.myctx:topic-value"},
		},
		{
			...
			act: func(t *testing.T, cl *sr.Client) (any, error) {
				return cl.SchemaVersionsByID(sr.InContext(context.Background(), ".myctx"), 1)
			},
		...
		},
		{
			...
			act: func(t *testing.T, cl *sr.Client) (any, error) {
				ctx := sr.InContext(context.Background(), ".myctx")
