...
[godev]: https://pkg.go.dev/github.com/twmb/frang/pkg/kgo
...
frang is an all-encompassing Kafka consumer api in Go. The main package is kgo,
but kmsg also exists containing autogenerated code for every request and
response type, and a few other miscellaneous packages exist.

The main package kgo is a high performance, pure Go library for interacting
with Kafka. This library aims to provide every Kafka feature from 0.8.0+.
